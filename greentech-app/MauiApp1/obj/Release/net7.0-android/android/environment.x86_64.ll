...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"833ce414-ecd2-428f-9f0f-53b5980556e0\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100671974, ; jnienv_initialize_method_token
	i32 100671973, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.42 = internal constant [30 x i8] c"libaot-System.Net.Quic.dll.so\00", align 16
...
@__DSOCacheEntry_name.47 = internal constant [50 x i8] c"libaot-System.Diagnostics.DiagnosticSource.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [548 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__DSOCacheEntry_name.42, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 45
	%struct.DSOCacheEntry {
