...
@__DSOCacheEntry_name.55 = internal constant [34 x i8] c"libaot-System.Net.Security.dll.so\00", align 1
...
@__DSOCacheEntry_name.64 = internal constant [23 x i8] c"libaot-MauiApp1.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [548 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.64, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 109
	%struct.DSOCacheEntry {
